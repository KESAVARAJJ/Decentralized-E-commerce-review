 ...
 * @author Admin1
 */
@WebServlet(urlPatterns = {"/SELLER_LOG"})
public class SELLER_LOG extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          String MAIL_ID=request.getParameter("MAIL_ID");
            ...
            System.out.println(MAIL_ID);
             ...
             System.out.println("Select * from seller_reg where MAIL_ID='"+MAIL_ID+"' and Password='"+Password+"'");
            DB db=new DB();
            ResultSet rs=db.Select("Select * from seller_reg where MAIL_ID='"+MAIL_ID+"' and Password='"+Password+"'");
              if(rs.next())
            {
                ...
                if(st.equals("NO"))
              {
                ...
                response.sendRedirect("SELLR_HOME.jsp");
                }
                else
                {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SELLER_LOG.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
